...
INSERT INTO warehouse (location, zone_id) VALUES ('chennai','tn01');
...
--UPDATE  account set balance=1250000 WHERE account_no=1227101051526;
...
select account_no from consumer where  consumer_name='ravi';
...
SELECT concat(prefix,m_id) as manager_id,manager_name, phone_no, aadhar_no, password, address, zone_id, account_no FROM management;
...
SELECT transaction_date, account_no, transaction_type, amount, description FROM transaction;
...
--INSERT INTO donation (staff_id,consumer_id,stock_id,quantity,fund_amount,description,donation_date,approved_by) 
--VALUES('E121','C101','S101 S102 S103',2,2500,'corona welfare fund',LOCALTIMESTAMP,'M101');

SELECT CONCAT(prefix,h_id) as donation_id, staff_id,consumer_id,stock_id,quantity,fund_amount,description,donation_date,approved_by,approval_status,zone_id FROM donation;
...
select concat(prefix,h_id) as history_id,zone_id,donation_year,no_of_civilians,donation_cause,donation_expenses from donation_history;
